...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class DbContextPoolEnhanceServiceCollectionExtensions
    {
        ...
        /// </returns>
        public static IServiceCollection AddDbContextEnhance<TContext>(
            this IServiceCollection serviceCollection,
            Action<DbContextOptionsBuilder<TContext>> optionsAction = null,
            ServiceLifetime contextLifetime = ServiceLifetime.Scoped,
            ServiceLifetime optionsLifetime = ServiceLifetime.Scoped)
            where TContext : DbContext
            => AddDbContextEnhance<TContext>(
                serviceCollection,
                optionsAction == null
                    ? (Action<IServiceProvider, DbContextOptionsBuilder<TContext>>)null
        ...
        ///     The same service collection so that multiple calls can be chained.
        /// </returns>
        public static IServiceCollection AddDbContextPoolEnhance<TContext>(
            this IServiceCollection serviceCollection,
            Action<DbContextOptionsBuilder<TContext>> optionsAction,
            int poolSize = 128)
            where TContext : DbContext
        {
            return AddDbContextPoolEnhance<TContext>(serviceCollection, (_, ob) => optionsAction(ob), poolSize);
        }
            ...
            where TContext : DbContext
        {
            ...
            serviceCollection.TryAddSingleton<DbContextPoolEnhance<TContext>>();
            serviceCollection.AddScoped(p => p.GetService<DbContextPoolEnhance<TContext>>().Rent());
        ...
        public static IServiceCollection AddDbContextEnhance<TContext>(
            ...
            ServiceLifetime optionsLifetime = ServiceLifetime.Scoped)
            where TContext : DbContext
            => AddDbContextEnhance<TContext>(serviceCollection, (Action<IServiceProvider, DbContextOptionsBuilder<TContext>>)null, contextLifetime, optionsLifetime);
